...
[見やすいxml](http://web.njj12.net/map.xml "小さいの")
  
  ...
  <a href="http://web.njj12.net/download/map.xml" download="map.xml"> サンプルのダウンロード</a>
...
<a href="http://web.njj12.net/download/map2.xml" download="map.xml"> サンプルのダウンロード</a>
...
![map.xml配置場所](https://raw.githubusercontent.com/njj12/njj12.github.io/master/public/images/mapNoIchi.png "map.xml配置場所")
 ...
 ---------------------
 #   座標取得プラグイン  
 サーバーに導入しコマンド/locを実行することでクリップボードに座標がコピーされます。  
  <a href="http://web.njj12.net/download/XmlSupport.jar" download="XmlSupport.jar"> プラグインのダウンロード</a>
